# [2022-08-nounsdao] QA report

###### tags: `c4`, `2022-08-nounsdao`, `QA`

## Shouldn't use `_` before name of external/public function  
...
Change comment 
* From `Check caller is pendingAdmin and pendingAdmin ≠ address(0)` 
* To `Check caller is vetoer`
